...
export default function Mainview() {
  ...
  return (
    <div className="flex justify-center items-center h-[100vh] bg-stone-900 relative">
      {visible && (<div className="absolute bg-red-100 w-[100%] md:w-[40%] lg:w-[35%] xl:w-[25%]" onClick={() => setVisible(!visible)}><CreateVideo /></div>)}
      ...
      <div className='absolute bottom-0 md:bottom-[5%] w-[100%] h-[8%] md:w-[40%] lg:w-[35%] xl:w-[25%] md:rounded-b-xl text-white w-full bg-black flex justify-between py-2 px-7 items-center'>
        ...
        <div onClick={() => setVisible(!visible)} className="bg-white w-[11%] h-6 rounded-md text-black flex justify-center items-center text-2xl">+</div>
